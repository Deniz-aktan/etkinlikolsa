...
function money(value: number | null) {
  return (
    new Intl.NumberFormat("tr-TR").format(Number(value || 0)) + " TL"
  );
}
    ...
    async function loadAccount() {
      ...
      const [
        ...
        supabase
          .from("reservations")
          .select(
            "id, event_id, customer_name, event_date, start_time, end_time, people, total_price, status, created_at"
          )
      ...
      <header className="sticky top-0 z-50 border-b border-slate-100 bg-white/95 backdrop-blur">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={() => router.push("/")}
              className="hidden rounded-full px-4 py-2 font-semibold hover:bg-slate-100 sm:block"
            >
              Anasayfa
            </button>
            ...
            <button
              onClick={logout}
              className="flex items-center gap-2 rounded-full border border-slate-200 px-4 py-2 font-semibold hover:bg-slate-50"
            >
              <LogOut size={17} />
              Çıkış Yap
            </button>
      ...
      <section className="mx-auto max-w-7xl px-5 py-10 lg:px-8">
        ...
        <div className="mb-8 rounded-3xl bg-gradient-to-r from-blue-600 to-blue-500 p-7 text-white shadow-lg">
          ...
          <h1 className="mt-2 text-3xl font-black">
            Merhaba, {profile?.full_name || "Hoş geldin"} 👋
          </h1>
        ...
        <div className="grid gap-6 lg:grid-cols-[280px_1fr]">
          ...
          <aside className="h-fit rounded-3xl bg-white p-3 shadow-sm ring-1 ring-slate-100">
            {[
              ...
              <a
                key={label as string}
                href={href as string}
                className="flex items-center justify-between rounded-2xl px-4 py-3.5 font-semibold hover:bg-slate-50"
              >
          ...
          <div className="space-y-6">
            ...
            >
              <div className="mb-5 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">
                    Rezervasyonlarını ve güncel durumlarını takip et
                  </p>
                </div>
              </div>
                    ...
                    >
                      <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                          ...
                          <span
                            className={`w-fit rounded-full border px-3 py-1.5 text-xs font-bold ${statusClass(
                              reservation.status
                            )}`}
                          >
                        ...
                        {reservation.status === "rejected" && (
                          <div className="rounded-xl border border-red-200 bg-red-50 p-3 text-sm text-red-800">
                            Bu rezervasyon admin tarafından
                            reddedildi.
                          </div>
                        )}
            ...
            >
              ...
              <p className="mt-2 text-sm text-slate-500">
                Rezervasyon onayı, iptal ve yaklaşan etkinlik
                bildirimleri burada görünecek.
              </p>
            </section>
